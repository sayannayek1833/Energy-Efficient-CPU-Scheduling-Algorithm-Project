...
def energy_efficient_round_robin(processes, quantum):
    ...
    while queue:
        ...
        if time < current['arrival']:  # If CPU is idle, move forward
...
def get_process_input():
    ...
    return processes
# def choice():
#     a=int(input("Enter 1 for FCFS , 2 for SJF and 3 for Round Robin: "))
#     if(a==1):
#        processes = get_process_input() 
#        fcfs_results = energy_efficient_fcfs(processes)
#        print("\nEnergy-Efficient FCFS Scheduling Results:")
#        for p in fcfs_results:
#         print(f"Process {p['id']}: Completion={p['completion']}, Waiting={p['waiting']}, Turnaround={p['turnaround']}")

#     elif(a==2):
#         processes = get_process_input()
#         sjf_results = energy_efficient_sjf(processes)
#         print("\nEnergy-Efficient SJF Scheduling Results:")
#         for p in sjf_results:
#             print(f"Process {p['id']}: Completion={p['completion']}, Waiting={p['waiting']}, Turnaround={p['turnaround']}")
#     elif(a==3):
#         processes = get_process_input() 
#         quantum = int(input("Enter Time Quantum: ")) 
#         rr_results = energy_efficient_round_robin(processes, quantum)
#         print("\nEnergy-Efficient Round Robin Scheduling Results:")
#         for p in rr_results:
#             print(f"Process {p['id']}: Completion={p['completion']}, Waiting={p['waiting']}, Turnaround={p['turnaround']}")
#     else:
